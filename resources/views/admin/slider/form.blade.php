...
<div class="admin-container">
    ...
    <div class="form-container">
        <h2>{{ isset($slider) ? 'Edit Slider Item' : 'Add New Slider Item' }}</h2>
        <form method="POST" 
            ...
            <div class="form-group">
                ...
                @if(isset($slider) && $slider->image)
                    <div style="margin-bottom: 10px;">
                        <img src="{{ asset('storage/' . $slider->image) }}" alt="Current image" class="slider-image">
                    </div>
            ...
            <div class="form-group">
                ...
                <input type="number" id="order" name="order" value="{{ old('order', $slider->order ?? '') }}" min="1" required>
                <small>Lower numbers appear first (e.g., 1, 2, 3)</small>
            </div>

            <button type="submit" class="btn btn-primary">
                {{ isset($slider) ? 'Update Slider Item' : 'Add Slider Item' }}
            </button>
